  ...
  return (
    <>
      <div className="relative -mt-[52px] w-screen h-screen">
        ...
        <div className="absolute top-1/8 right-0 left-0 max-w-[1280px] flex flex-col items-center gap-10 m-auto px-4">
          <Image
            src={"/images/me.png"}
            alt={"My avatar"}
            width={500}
            height={500}
            className="w-30 h-30 md:w-50 md:h-50 object-cover rounded-full border-2 border-dark-primary bg-light-primary"
          />
          <Title className="text-center bg-light-primary border-2 border-dark-primary rounded-md md:rounded-full p-4 md:px-8">
            <span className="hidden md:inline-block">Welcome!</span> I&apos;m Lucas Regalado
          </Title>
          <p className="text-center bg-light-primary border-2 border-dark-primary rounded-md md:rounded-full p-4 md:px-8">
